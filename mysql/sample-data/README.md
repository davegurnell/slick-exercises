...
Sample data for use in MySQL. Adapted from [this repo](https://github.com/datacharmer/test_db).
The remainder of this file quotes their [README.md](https://github.com/datacharmer/test_db/blob/master/README.md).
